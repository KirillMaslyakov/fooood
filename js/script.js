...
getStaticInformation('#gender','calsulating_choose-item_active');
getStaticInformation('.calsulating__choose_big', 'calsulating_choose-item_active');